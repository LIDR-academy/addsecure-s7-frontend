Create a comprehensive product specification in Notion and a corresponding Linear ticket for: $ARGUMENTS
...
2. **Create Comprehensive Notion Specification**
   **IMPORTANT**: Create the specification in the "LTI frontend" directory in Notion.
